...
cryolite_ratio_frame.grid(row=1, column=1, padx=10, pady=10, sticky="w")
...
alumina_sat_frame.grid(row=1, column=2, padx=10, pady=10, sticky="w")
...
alumina_activ_frame.grid(row=1, column=3, padx=10, pady=10, sticky="w")
...
bath_cond_frame.grid(row=1, column=4, padx=10, pady=10, sticky="w")
